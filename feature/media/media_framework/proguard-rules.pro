...
-keep @kotlinx.serialization.Serializable class com.davidluna.tmdb.media_framework.data.remote.model.** { *; }
...
-keep class com.davidluna.tmdb.media_framework.** { *; }
-dontwarn com.davidluna.tmdb.media_framework.**