...
import com.davidluna.architectcoders2024.media_framework.data.remote.media.RemoteCast
import com.davidluna.architectcoders2024.media_framework.data.remote.media.RemoteGenre
import com.davidluna.architectcoders2024.media_framework.data.remote.media.RemoteImage
...
fun RemoteResults<RemoteMedia>.toDomain(): Results<Media> = Results(
    ...
    results = results
        ...
        .map(com.davidluna.architectcoders2024.media_framework.data.remote.media.RemoteMedia::toDomain),
