...
import com.davidluna.architectcoders2024.app.data.local.datastore.ProtoSessionDataSource
...
abstract class DataModule {
    ...
    @Binds
    abstract fun bindLocalStorageDatastore(dataStore: ProtoSessionDataSource): LocalSessionDataSource
